  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className=" bg-[#161416] text-white flex items-center flex-col gap-8 justify-center text-center py-[8rem]">
        <div className=" relative w-full sm:w-fit lg:w-full lg:max-w-[1000px] py-[4rem] flex flex-col gap-7 sm:gap-[3rem]">
          <motion.h2 className="text-[4rem] sm:text-[6rem] sm:leading-[6rem]  flex flex-col justify-center font-semibold leading-[4rem] xl:leading-[8rem] z-[100] lg:text-[8rem]">
            <span>Create</span> <span>payment</span> <span>requests</span>
          </motion.h2>
          ...
          <div className="absolute left-0 top-0 h-full w-full z-[10]">
            {/* coin1 */}
            <div className="w-[80px] sm:w-[130px] absolute bottom-[-10%] left-[4%] sm:left-[-30%] sm:bottom-[-10%] md:left-[-50%] lg:bottom-[0%] lg:left-[0%]">
              <video autoPlay loop muted>
                <source src="/coin_2.mp4" type="video/mp4" />
              </video>
            </div>
            {/* coin2 */}
            <div className="w-[80px] sm:w-[130px] absolute right-[5%] top-[-10%] sm:right-[-15%] md:right-[-20%] md:top-[-5%] lg:top-[0%] lg:right-[0%]">
              <video autoPlay loop muted>
                <source src="/coin_1.webm" type="video/webm" />
              </video>
            </div>
            {/* coin3 */}
            <div className="w-[80px] sm:w-[130px] absolute right-[5%] bottom-[5%] sm:right-[-25%] sm:bottom-[-5%] md:right-[-40%] lg:bottom-[0%] lg:right-[0%]">
              <video autoPlay loop muted>
        ...
        <div className="w-[90%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 z-[100] mt-[8rem]">
      ...
      <div className="bg-[#161416] h-screen text-white py-[3rem] md:py-[8rem]">
        <div className="w-[90%] mx-auto flex flex-col gap-8 md:flex-row md:justify-center lg:gap-0 md:items-center">
